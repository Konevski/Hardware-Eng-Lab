...
HD_PWD='C:/Users/GABRUUU/Desktop/VSLI lab/VLSI_PROJ_MB_HW/VLSI_PROJ_MB_HW.runs/MB_DESIGN_clk_wiz_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_DESIGN_clk_wiz_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_DESIGN_clk_wiz_1_1.tcl
