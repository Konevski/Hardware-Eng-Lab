...
HD_PWD='C:/Users/konev/Desktop/VLSI_PROJ_MB_HW_02/VLSI_PROJ_MB_HW_02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HARDWARE_ARCHI_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HARDWARE_ARCHI_wrapper.tcl -notrace
