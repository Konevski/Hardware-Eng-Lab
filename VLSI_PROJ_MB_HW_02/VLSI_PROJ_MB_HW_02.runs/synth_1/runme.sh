...
HD_PWD='C:/Users/konev/Desktop/VLSI_PROJ_MB_HW_02/VLSI_PROJ_MB_HW_02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HARDWARE_ARCHI_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HARDWARE_ARCHI_wrapper.tcl
