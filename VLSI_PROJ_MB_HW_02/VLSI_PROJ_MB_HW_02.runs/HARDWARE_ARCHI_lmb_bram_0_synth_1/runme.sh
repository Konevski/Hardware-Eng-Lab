...
HD_PWD='C:/Users/konev/Desktop/VLSI_PROJ_MB_HW_02/VLSI_PROJ_MB_HW_02.runs/HARDWARE_ARCHI_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HARDWARE_ARCHI_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HARDWARE_ARCHI_lmb_bram_0.tcl
